...
def extract_features(
    positions, feet_thre=0.002, n_raw_offsets=n_raw_offsets, kinematic_chain=kinematic_chain, 
    face_joint_indx=FACE_JOINT_INDX, fid_r=FID_R, fid_l=FID_L
):
...
def main():
    example_id_path = Path("/proj/vondrick2/orr/motion-diffusion-model/human_feedback/examples/000021.npy")
    # Lower legs
    l_idx1, l_idx2 = 5, 8
    # Right/Left foot
    fid_r, fid_l = [8, 11], [7, 10]
    ...
    source_list = list(data_dir.rglob("*.npy"))
    frame_num = 0
